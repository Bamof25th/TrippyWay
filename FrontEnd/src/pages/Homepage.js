...
const Homepage = () => {
  ...
  return (
        ...
        <div className="w-full h-full top-0 z-10 flex justify-center">
          ...
          <div className="flex flex-col gap-3 items-center justify-center w-1/2 text-white bg-glassy my-10 mx-28 px-28 rounded-lg shadow-md">
            ...
            <span className="text-1xl font-bold text-red-400">
              <Typewriter
                words={[
                  "TourAI: Your personalized travel guru.",
            ...
            <p className="text-lg mb-8">
              Explore the possibilities of AI-powered travel experiences.
            </p>
            <div className="typewriter-container">
              <span className="typewriter">
                Typing out some text about Tour...
              </span>
            </div>
            <textarea
              className="w-[450px] resize-none p-4 mt-4 mb-4 bg-gray-800 rounded-lg border border-gray-600 text-white focus:outline-none focus:border-blue-500"
    ...
    <button class="inline-flex items-center justify-center text-white text-sm font-medium  border border-input bg-[#2b3030] hover:bg-emerald-800  duration-300 h-9 rounded-md px-3">
      View more
    </button>
          </div>
        ...
        <div className="relative flex flex-col gap-52 justify-center items-center z-10 container mx-auto text-center h-[800px]">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="relative p-10 py-16 flex flex-col gap-2 bg-white rounded-lg shadow-md justify-center items-center transform transition-transform duration-300 hover:shadow-2xl hover:scale-105">
              ...
              <h3 className="mt-20 mb-2 text-xl font-bold text-deep-purple">
                Search Destinations
              </h3>
